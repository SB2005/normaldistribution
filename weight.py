...
h_mean = st.mean(weight_list)
h_mode = st.multimode(weight_list)
h_median = st.median(weight_list)
h_sd = st.stdev(weight_list)
...
percent_sd1 = (h1/len(weight_list))*100
print(percent_sd1)

percent_sd2 = (h2/len(weight_list))*100
print(percent_sd2)

percent_sd3 = (h3/len(weight_list))*100
print(percent_sd3)
